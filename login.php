							...
							<div class="row-fluid">
								<div class="center">
									<h1>
										...
										<span class="white">APLIKASI DUPAK</span>
									</h1>
									<h4 class="white">Kabupaten Tangerang - Banten</h4>
								</div>
							</div>
									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												 <div align="center"><img src="assets/images/logo_warna.jpg" class="img-polaroid"/></div>
											...
											<div class="widget-main">
												<div>
													 <span class="lbl">Copyright  &copy; 2016 - 2017 Dinkes Kab.Tangerang</span>
												</div>
											</div>
										</div><!--/widget-body-->
									</div><!--/login-box-->
