...
<div id="alert"></div>
<div class="row-fluid">
<h3 class="header smaller lighter blue">Laporan Kegiatan Harian</h3>
	<div class="table-header">		
	</div>

<form id="forms" method="post" action="kegiatan/print.php" target="_blank" class="form-horizontal">
<div class="span8">
