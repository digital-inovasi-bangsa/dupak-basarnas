...
if(!empty($_POST['unit_kerja'])){
	...
	if($unit->create($unit_kerja,$alamat_unit_kerja,$keterangan,$aktif,$created_by)){
		$sg   = "ok";
...
<form id="forms" method="post" onSubmit="return submitForm('<?php echo $_SERVER['PHP_SELF']; ?>')" class="form-horizontal">
	<fieldset>
		<legend>Tambah Unit Kerja</legend>
		<span>
		 <?php
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<label class="control-label" for="unit_kerja" >Unit Kerja</label>
					<div class="controls">
					<input type="text" id="unit_kerja" name="unit_kerja" autocomplite="off" required autofocus />
					</div>
				</div>
				<div class="control-group">
				<label class="control-label" for="alamat_unit_kerja" >Alamat</label>
					<div class="controls">
					<textarea class="span12" id="alamat_unit_kerja" name="alamat_unit_kerja"></textarea>
					</div>
				</div>
				<div class="control-group">
