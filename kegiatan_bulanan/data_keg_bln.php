...
<div id="alert"></div>
<div class="row-fluid">
<h3 class="header smaller lighter blue">Daftar Kegiatan Bulanan </h3><!-- <input type="text" name="tgl" id="tgl" class="tanggal" value="<?php echo date('d-m-Y'); ?>" required name="tgl" data-date-format="dd-mm-yyyy" /> <i class="icon-calendar bigger-150"></i>--> 
