...
include_once('class.usulan_dupak.php');
$keg = new usulan_dupak($pdo);
?>
<div id="alert"></div>
<div class="row-fluid">
...
<form id="forms" method="post" action="lap_dupak/print_usulan_dupak.php" target="window.open()" class="form-horizontal">
<div class="span8">
