...
include_once('class.pak.php');
$keg = new pak($pdo);
?>
<div id="alert"></div>
<div class="row-fluid">
<h3 class="header smaller lighter blue">Laporan Penetapan Angka Kredit</h3>
	<div class="table-header">		
	</div>

<form id="forms" method="post" action="lap_dupak/print_pak.php" target="_blank" class="form-horizontal">
<div class="span8">
	...
	<!--
	<div class="control-group">
	<label class="control-label" for="kepala" >Pejabat Pengusul/NIP</label>
		<div class="controls">
		<input type="text" id="pengusul" name="pengusul" required class="span6" placeholder="Nama Pejabat Pengusul">
		<input type="text" id="nip1" name="nip1" required class="span4" placeholder="NIP">
		</div>
	</div>
	<div class="control-group">
	<label class="control-label" for="kepala" >Ketua Tim Penilai</label>
		<div class="controls">
	...
	<div class="control-group">
	<label class="control-label" for="kepala" >Pejabat Penilai</label>
		<div class="controls">
		<input type="text" id="pejabat_penilai" name="pejabat_penilai" required class="span6" placeholder="Nama Pejabat Penilai">
